...
glass = commands.Bot(command_prefix=get_prefix, help_command=None, self_bot=True, case_insensitive=True, member_cache_flags=discord.MemberCacheFlags.all(), fetch_offline_members=True)
